...
<ProjectCard
  title="Como descubrir nuevas medicinas con Python"
...
<ProjectCard
  title="Google Earth Engine para Investigación"
...
<ProjectCard
  title="Algunas herramientas que he aprendido y me gusta usar"
